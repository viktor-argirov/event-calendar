<header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="../index.php">Evénements</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav  me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="template.php?page=planning">Evénements de la semaine</a>
                    </li>
                    <li class="nav-item"> <!-- Onglet réservation désactivé si utilisateur déconnecté-->
                        <a class="nav-link <?php if (!isset($_SESSION['user'])){echo 'disabled';}?>" href="template.php?page=reservation-form">Faire un événement</a>
                    </li>
